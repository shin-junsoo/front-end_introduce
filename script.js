...
const todosContainer = document.querySelector('.guestbook-container');
...
function renderTodos(todos) {
    ...
    todos.forEach(todo => {
        ...
        todoDiv.classList.add('guestbook-item');
...
const todoInput = document.querySelector('.guestbook-input');
